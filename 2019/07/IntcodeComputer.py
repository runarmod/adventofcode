...
class IntcodeComputer:
    def __init__(self, nums):
        ...
        self.arg_count = [0, 3, 3, 1, 1, 2, 2, 3, 3]

        self.inputs = []
        self.in_function = lambda: (
            self.inputs.pop(0) if self.inputs else int(input("Enter a number: "))
        )
    ...
    def step(self):
        ...
        for parameter, mode in zip(parameters, modes):
            [parameter.refer_as_address, parameter.refer_as_value][mode]()
